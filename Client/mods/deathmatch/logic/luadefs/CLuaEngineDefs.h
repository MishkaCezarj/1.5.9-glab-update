...
public:
    ...
    LUA_DECLARE(GetLaunchData);
    LUA_DECLARE(SettingsGame);
    LUA_DECLARE(ExitGame);
    LUA_DECLARE(TakeScreenShot);
    LUA_DECLARE(IsLoadingScreenVisible);
    LUA_DECLARE(TurnOFf);
    LUA_DECLARE(SetLoadingScreenVisible);
