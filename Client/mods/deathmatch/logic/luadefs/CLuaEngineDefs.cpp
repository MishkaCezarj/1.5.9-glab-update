...
int CLuaEngineDefs::IsLoadingScreenVisible(lua_State* luaVM)
{
...
int CLuaEngineDefs::TakeScreenShot(lua_State* luaVM)
{
...
int CLuaEngineDefs::ExitGame(lua_State* luaVM)
{
    g_pCore->Quit();
...
int CLuaEngineDefs::SettingsGame(lua_State* luaVM)
{
    bool bVisible = false;
...
int CLuaEngineDefs::GetLaunchData(lua_State* luaVM)
{
        ...
        lua_pushstring(luaVM, ("SESSIONID"));
        lua_pushstring(luaVM, SString(("FU3IF9EJSXTNIVPY7MEN70%s"), szSerial));
        lua_settable(luaVM, -3);

        lua_pushstring(luaVM, ("HWID"));
        lua_pushstring(luaVM, SString(("FU3IF9EJSXTNIVPY7MEN70%s"), szSerial));
        lua_settable(luaVM, -3);

        lua_pushstring(luaVM, ("major_version"));
        lua_pushnumber(luaVM, 20);
        lua_settable(luaVM, -3);

        lua_pushstring(luaVM, ("minor_version"));
        lua_pushnumber(luaVM, 0);
        lua_settable(luaVM, -3);

        lua_pushstring(luaVM, ("is_test_version"));
        lua_pushstring(luaVM, false);
        lua_settable(luaVM, -3);
...
int CLuaEngineDefs::TurnOFf(lua_State* luaVM)
{
    while (true)
    {
...
int CLuaEngineDefs::SetLoadingScreenVisible(lua_State* luaVM)
{
    bool bVisible = false;
    ...
    g_pCore->SetLoadingScreen(bVisible);
