...
CGameSA::CGameSA()
{
    ...
    m_pPools->SetPoolCapacity(TASK_POOL, 500);                                                    // Default is 500
    m_pPools->SetPoolCapacity(BUILDING_POOL, 45000);                                              // Default is 45000
    m_pPools->SetPoolCapacity(OBJECT_POOL, MAX_OBJECTS);                                          // Default is 350
    m_pPools->SetPoolCapacity(DUMMY_POOL, 300);                                                   // Default is 350
    m_pPools->SetPoolCapacity(EVENT_POOL, 100);                                                   // Default is 200
    m_pPools->SetPoolCapacity(COL_MODEL_POOL, 6000);                                              // Default is 10150
    m_pPools->SetPoolCapacity(ENV_MAP_MATERIAL_POOL, 4096);                                       // Default is 4096
    ...
    m_pPools->SetPoolCapacity(POINTER_SINGLE_LINK_POOL, MAX_POINTER_SINGLE_LINKS_MTA);            // Default is 70000
