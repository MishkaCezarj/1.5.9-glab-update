...
public:
    ...
    std::shared_ptr<CDiscordManagerInterface> GetDiscord();

    void SetLoadingScreen(bool bVisible);
    ...
    void        OpenSettings(bool bVisible);
    bool        IsFirstFrame() const noexcept { return m_bFirstFrame; }

    CGUILabel* m_pMessageBox;
...
private:
    ...
    std::shared_ptr<CDiscordManager> m_DiscordManager;
