...
#define CGUI_MTA_OPEN_SANS_FONT     "cgui/open-sans.ttf"            // GUI Label Main Menu
#define CGUI_SA_HEADER_SIZE         26
#define CGUI_SA_GOTHIC_SIZE         47
#define CGUI_MTA_SANS_FONT_SIZE     9
#define CGUI_MTA_OPEN_SANS_SIZE     17
...
CGUI_Impl::CGUI_Impl(IDirect3DDevice9* pDevice) : m_HasSchemeLoaded(false), m_fCurrentServerCursorAlpha(1.0f)
{
    ...
    */
    ...
    try
    {
        ...
        m_pOpenSansFont = (CGUIFont_Impl*)CreateFnt("open-sans", CGUI_MTA_OPEN_SANS_FONT, CGUI_MTA_OPEN_SANS_SIZE, 0, false);
    }
    catch (CEGUI::InvalidRequestException e)
    {
        SString strMessage = e.getMessage().c_str();
...
CGUIFont* CGUI_Impl::GetOpenSansFont()
{
    return m_pOpenSansFont;
}
