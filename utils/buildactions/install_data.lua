...
local NET_PATH_X64_MACOS = "http://mirror.mtasa.com/bdata/net.dylib"
...
newaction {
	...
	execute = function()
		...
		if os.host() == "windows" then
            ...
            -- if os.isfile(discord_path) then
            --     os.copyfile(Discord_DIR.."/x86/discord_game_sdk.dll", BIN_DIR.."/MTA/discord_game_sdk.dll")
            --     print("Successfully copied Discord SDK")
            -- else
            --     print("Error copying Discord SDK was not copied due to the absence of a file")    
            --     os.exit(1)
            --     return
            -- end
