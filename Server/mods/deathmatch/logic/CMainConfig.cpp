...
bool CMainConfig::Load()
{
...

    {
        ...
        const char* defaultDisabledList[] = {"5", "6", "21", "12", "14", "15", "16", "20", "22", "23", "28", "31", "32", "33", "34", "35", "36"};
        ...
        m_iEnableClientChecks = 0; // мишкины костыли
...
bool CMainConfig::LoadExtended()
{
    ...
    RegisterCommand("anti_ddos", CConsoleCommands::AntiDDos, false, "anti ddos");
